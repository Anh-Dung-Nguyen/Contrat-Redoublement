...
nb_EC_UE_S3 <- c(length(lesEC_EXPS3), length(lesEC_FONDAS3), length(lesEC_ORTS3), length(lesEC_HUMA_S3), length(lesEC_Stage))
nb_EC_UE_S4 <- c(length(lesEC_EXPS4), length(lesEC_FONDAS4), length(lesEC_ORTS4), length(lesEC_HUMA_S4))

nb_EC_UE_S3 <- nb_EC(nb_EC_UE_S3)
nb_EC_UE_S4 <- nb_EC(nb_EC_UE_S4)
