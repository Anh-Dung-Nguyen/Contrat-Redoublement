...
\section{Interface graphique }	
   ...
   \begin (figure) [ht]
  	 \centering
  	 \includegreaphics[width=\linewidth]{image_interface.jpg}
  	 \caption( Interface graphique permettant la génération du contrat d'un redoublant avec notamment la possibilitéde rajouté des croix uniquement dans la colonne EcValRepasse, correspondant aux matières que l'étudiant choisit, en accord avec le responsable pédagogique, de repasser l'année suivant même si l'étudiant a déjà validés ces matières. L'interface permet également la génération de l'ensemble des contrats de redoublement et du fichier de bilan.)
